<?php
	...
	$content = addslashes($obj->content);

	mysqli_query($con, "INSERT INTO knowledgeFiles (projectId, displayName, author, title, body) VALUES ('$projectId','$title','$author','$title','$content')") or die(error("Error: Adding new html"));
